        ...
        <div className="row">
          ...
          <div className="col-3">
            <Link to="mypage/info">
              ...
              <span className={style.footer_text}>Mypage</span>
            </Link>
          </div>
          <div className="col-3">
            <Link to="/posts">
    ...
    <>
      <div className={`${style.footer} d-none d-md-block`}>
        <div className={`${style.footer_t} row`}>
          <div className="col-4 footer-l">
            <ul className={`${style.footer_list} mt-4`}>
              <li>
                <h3 style={{ fontSize: "1rem" }}>Bang-Guseog</h3>
              </li>
        ...
        <div className="row" style={{ margin: "0px" }}>
          <div
            className={`${style.copyRight} col-12 d-flex justify-content-center mb-4 copyRight`}
            style={{ padding: "0px" }}
          >
